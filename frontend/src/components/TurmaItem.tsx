            ...
            >
                ...
                >
                    <Box
                        ...
                        width='50%'
                    >
                        <Typography variant="h3" fontSize={26}>Turma</Typography>
                    ...
                    <Box
                        ...
                        width='50%'
                    >
                        <Typography variant="h3" px='20px'>Vagas</Typography>
                        <Typography>{turma.capacidadeAtual}</Typography>
                    </Box>
                </Box>
                <Box>
                    <Button sx={{ color: '#fff' }} onClick={() => reazliarMatricular()}>Escolher</Button>
                </Box>
            </Box>
        </Paper>
